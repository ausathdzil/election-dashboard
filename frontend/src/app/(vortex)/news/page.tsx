...
export default async function BlogPage(props: BlogPageProps) {
  ...
  return (
    <main className="flex w-full flex-1 flex-col">
      <NewsHeader />
      <div className="flex flex-col lg:flex-row w-full gap-8 border-t p-8 lg:px-24 shadow-xs">
...
function NewsHeader() {
  return (
    <section className="flex flex-col lg:flex-row lg:justify-between gap-8 bg-[#FAFBFC] px-8 pt-8 lg:px-24 lg:pt-10">
      <article className="lg:max-w-[500px] space-y-2 lg:space-y-4">
...
async function RecommendationSection(props: NewsSectionProps) {
  ...
  return (
    <section className="space-y-8 border-t lg:border-l lg:border-t-0 px-0 py-8 lg:px-8">
